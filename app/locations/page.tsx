...
import CruelSeasonLocationCard from "@/component/CruelSeasonLocationCard";
import {CruelSeasonLocation} from "@/model/CruelSeasonLocation";
import CruelSeasonText from "@/component/CruelSeasonText";

export default function LocationPage() {
    const locations: CruelSeasonLocation[] = [
        {
            title: 'Mountain',
            description: 'A Gorgeous mountain, located north of <INSERT PLACE HERE>.',
            imageUrl: '/smiley_face.png'
        },
        {
            title: 'Lake',
        ...
        <div style={appStyles.body}>
            ...
            </CruelSeasonText>
            {
                locations.map((locationItem, index) => (
                    <CruelSeasonLocationCard location={locationItem} key={index}/>
                ))
            }
        </div>
    )
